...
def _merge_table_and_columns(table_data: dict, col_data: dict) -> dict:
    ...
    # Build searchable text from the rich YAML fields
    ...
    # Collect all keywords for backward compat
...
def build():
    ...
    # Build column synonyms flat dict for backward compat with engine
    col_syns = {}
