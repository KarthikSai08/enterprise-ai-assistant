...
COLUMN_META = {
    ...
    ("dim_TaxRate", "taxName"): {"aliases": ["tax name", "gst name", "tax code", "gst code"], "role": "dimension", "importance": "high", "description": "Full name of tax rate"},
    ...
    ("dmn_City", "cityName"): {"aliases": ["city", "city name", "town", "place"], "role": "dimension", "importance": "high", "description": "Name of the city", "sample_values": ["Ahmedabad", "Mumbai", "Delhi", "Bangalore", "Chennai", "Kolkata", "Hyderabad", "Pune", "Jaipur", "Surat", "Lucknow", "Kanpur", "Nagpur", "Indore", "Thane", "Bhopal", "Visakhapatnam", "Vadodara", "Patna"], "search_keywords": ["city", "city name", "town", "location", "place", "municipality"], "common_user_intents": ["Which city", "Cities list", "City wise reports", "Filter by city", "Group by city"]},
    ...
    ("dmn_State", "stateName"): {"aliases": ["state", "state name", "region"], "role": "dimension", "importance": "high", "description": "Full name of the state", "sample_values": ["Maharashtra", "Gujarat", "Rajasthan", "Karnataka", "Tamil Nadu", "Kerala", "Andhra Pradesh", "Telangana", "Uttar Pradesh", "Delhi", "Haryana", "Punjab", "Madhya Pradesh", "West Bengal"]},
    ...
    ("tbl_Department", "deptName"): {"aliases": ["department", "dept name", "dept"], "role": "dimension", "importance": "high", "description": "Name of the department"},
    ("tbl_Designation", "desigName"): {"aliases": ["designation", "job title", "title", "position"], "role": "dimension", "importance": "high", "description": "Name of the job designation/title"},
